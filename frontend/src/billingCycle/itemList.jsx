...
import { currencyMask } from '../../src/util/Moeda'
    ...
    rendRows() {
        ...
        return list.map((item, index) => (
                <tr key={index}>
                    ...
                    <td><Field {...currencyMask}  id="valor" onkeyup={this.formatarMoeda} name={`${this.props.field}[${index}].value`} component={Input} placeholder='Informe o valor'  readOnly={this.props.readOnly}/></td> 
